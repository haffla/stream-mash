require.config({
    paths: {
        jquery: '/webjars/lib/jquery/jquery.min'
        bootstrap: '/webjars/lib/bootstrap/js/bootstrap.min'
        progressbar: '/webjars/lib/progressbar.js/dist/progressbar.min'
        lodash: '/webjars/lib/lodash/lodash.min'
    },
    shim: {
...
require ['react', 'material', 'jquery', 'bootstrap', 'progressbar', 'lodash'], (React, Mui, $, _bootstrap, ProgressBar, _) ->
  $(document).ready () ->
    # JUST A HELPER FOR COMMON TASKS ----------------

    console.log(Mui)

    ws = new WebSocket('ws://localhost:9000/soundcloud/socket')
        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-md-5 col-md-offset-3 col-sm-6 col-xs-6">
                  ...
                  <button className="btn btn-primary" data-target="#fileuploadmodal" role="button" data-toggle="modal">
    ...
    React.render <MainComponent />, document.getElementById('affe')
